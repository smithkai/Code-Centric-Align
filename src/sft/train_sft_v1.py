...
def train():
    ...
    training_args = TrainingArguments(
        ...
        per_device_train_batch_size=4,  # 原来是4,1,4,这个参数基本是batchsize的意思,一次前向传播塞进显卡的数据量
        gradient_accumulation_steps=4,  # 原来是4,16,4,多少次前向传播计算一次梯度的参数
        learning_rate=2e-4,
        logging_steps=5,
        num_train_epochs=3,
        save_steps=100,
